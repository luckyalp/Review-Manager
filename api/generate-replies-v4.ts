...
- UNTERFALL GESCHMACK SUBJEKTIV NICHT GETROFFEN (z.B. "war nicht so meins"): Gleiches Muster, z.B. "Sag uns beim naechsten Besuch einfach kurz Bescheid, was du magst, dann koennen wir dir etwas Passendes empfehlen."
- DREITEILUNG BEI GESCHMACK/SAETTIGUNG-THEMEN: (1) Geht es um MENGE/SAETTIGUNG (z.B. "zu wenig", "nicht satt geworden", "Portion knapp")? → "Sag uns Bescheid, dann finden/empfehlen wir was Passendes zu deinem Hunger" (offen, kein konkretes Zusatzprodukt, NICHT "mehr von demselben"). (2) Nennt der Gast ein konkretes ZUBEREITUNGSMERKMAL DESSELBEN Gerichts (z.B. Wuerze, Schaerfe, Temperatur, Garstufe)? → "Sag uns Bescheid, dann passen wir [Merkmal] fuer dich an" (dasselbe Gericht, angepasst). (3) Beschreibt der Gast die generelle RICHTUNG/den Stil des Gerichts als nicht seins, ohne konkretes anpassbares Merkmal? → "Sag uns, was du magst, dann empfehlen wir dir etwas Passendes" (anderes Gericht).
...
- UNTERFALL SERVICE-WAHRNEHMUNG SUBJEKTIV (kein konkreter Vorwurf, nur Eindruck, z.B. "kam mir unfreundlich/gehetzt vor"): "empfehlen" passt hier NICHT. Bei kurzer Bewertung reicht reine Validierung ohne weiteren Satz (z.B. "Schade, dass du das so erlebt hast."). Bei ausfuehrlicherer Bewertung kann ein Kanal-Hinweis ergaenzt werden: "Was genau in dem Moment passiert ist, koennen wir im Nachhinein nicht mehr nachvollziehen. Beim naechsten Mal sprich einfach kurz jemanden vom Team an, dann koennen wir direkt reagieren." Kein Schuldeingestaendnis, kein Versprechen.
