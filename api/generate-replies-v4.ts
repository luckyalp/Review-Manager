...
Beispielsätze: "Was genau passiert ist, wissen wir so nicht." / "Das können wir im Nachhinein nicht mehr nachvollziehen." / "Damit wir das einordnen können, brauchen wir mehr."
...
Satz 3 ist die ehrliche Slot-3A-Einordnung ("das koennen wir im Nachhinein nicht mehr nachvollziehen") mit natuerlichem Uebergang (z.B. "Ehrlich gesagt,"), als eigener klarer Satz. Baue daraus KEINEN Bandwurmsatz mit der Validierung aus Satz 1 — also NICHT "Letztendlich war's nicht in Ordnung, und das koennen wir nicht nachvollziehen, ohne mehr zu wissen" o.ae.
