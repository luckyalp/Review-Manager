...
- FUER ALLE ANDEREN GESCHMACKS-/WAHRNEHMUNGSTHEMEN (Wuerze, Schaerfe, Temperatur, "fad", "war nicht so meins", Atmosphaere etc.): bleibe beim offenen Muster aus Zeile oben ("passen wir [X] fuer dich an" bzw. "empfehlen wir dir etwas Passendes") — [X] frei an die konkrete Bewertung anpassen, KEINE feste Kategorisierung erzwingen.
