...
- Pruefe: Hat der Gast das Problem bereits VOR ORT angesprochen und wurde es geloest (z.B. "Hab's der Kellnerin gesagt, dann kam er richtig")? Dann KEINE Geste/Aufforderung anbieten ("sag uns Bescheid" o.ae.) — das waere zirkulaer, der Gast hat das schon getan. Stattdessen reicht Validierung + Verantwortung, optional eine kurze Anerkennung, dass die Korrektur vor Ort gepasst hat (diese Anerkennung uebernimmt die ABSCHLUSS-Funktion fuer diese Antwort).
- Falls der Gast NICHTS vor Ort gesagt hat: biete eine persoenliche Geste fuer ein KUENFTIGES Mal an. Pruefe dabei, WANN der Gast das Problem realistischerweise haette merken/melden koennen:
  - Wenn das Problem WAEHREND des Besuchs hätte auffallen können (z.B. falsches Gericht, lange Wartezeit): formuliere die Geste als "kurz Bescheid geben, waehrend man noch da ist", z.B. "Sprich uns einfach kurz an, dann schauen wir sofort, wo's hakt" oder "Wink uns kurz, dann kuemmern wir uns gleich". Vermeide unnatuerliche Konstruktionen wie "auf uns zuschauen".
  - Wenn das Problem laut Bewertung ERST SPAETER/NACH DEM BESUCH aufgefallen ist (z.B. "erst zu Hause aufgefallen"): biete KEINE Geste an, die voraussetzt, dass der Gast noch vor Ort ist (z.B. "sag uns direkt am Tisch Bescheid" passt hier NICHT). Formuliere stattdessen eine Geste fuer das naechste Mal, die VOR dem Verlassen passiert, z.B. "Schau beim naechsten Mal am besten kurz, bevor du gehst, ob alles passt, dann koennen wir das direkt vor Ort klaeren."
  Diese Geste uebernimmt die ABSCHLUSS-Funktion fuer diese Antwort.
