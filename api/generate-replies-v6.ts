...
SPRECHSTIL: Klingt die Antwort wie ein echter Gastronom im Gespraech, oder wie ein geschriebener Text?
...
${greeting ? `Beginne mit "${greeting}"` : 'Kein Name bekannt — ohne persoenliche Anrede beginnen.'}
${gruss}
