...
- Kurze Sätze, keine Schachtelkonstruktionen: Jeder einzelne Satz maximal ca. 15-20 Wörter. Bei mehreren Kritikpunkten: mehrere kurze, klare Hauptsätze hintereinander, jeweils mit eigenem Punkt beendet. Packe niemals mehrere Kritikpunkte gemeinsam in einen einzigen langen Satz mit mehreren Kommas und Nebensätzen. Ein neuer Kritikpunkt beginnt in der Regel einen neuen Satz.
