...
- VERBOTENE SPRACHE: Keine Floskeln ("Das ist nicht unser Standard", "Wir bessern uns", "zeitnah", "austauschen", "die Sache in Ordnung bringen", "handwerklich"). Keine der Wörter "verstehen", "nachvollziehen", "nachempfinden" oder Abwandlungen (z.B. NICHT: "Ich kann deinen Ärger verstehen"). Kein Amtsdeutsch (NICHT "aufgebaut", "durchgeführt", "das darf nicht der Eindruck sein" - STATTDESSEN "so machen wir das", "passiert ist", "das soll nicht so rüberkommen"). Keine unnatürlichen Ich-Beteuerungen wie "ich rede das nicht schön" oder "das will ich nicht schönreden".
