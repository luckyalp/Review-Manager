...
Variante 3 – Fokus auf Klaerung: Kuerzer, max. 3 Saetze. Startet mit "Hi ${firstNameCapitalized}," oder "Hallo ${firstNameCapitalized}," (kein Name bekannt: "Hi," oder "Hallo,"). Kein separater Kontaktlink, keine E-Mail-Adresse in dieser Variante. Endet immer mit genau diesem Satz: "Schreib uns einfach kurz, dann kuemmern wir uns persoenlich darum." — gefolgt vom Abschlussgruss. Kein "damit wir verstehen was passiert ist", kein "wir wollen das einordnen".
